...
while True:
    event, values  = window.read(timeout=200)      #*event tells you what happened (e.g., "Add" or "Edit"), values holds what the user typed or selected
    ...
    match event:
        ...
        case "Edit":
            try:
                ...
                sg.popup("Please select an item first", font=("Helvatica", 20))
        case "Complete":
            try:
